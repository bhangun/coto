...
func TestRenameCommand_RenameFile_Prefix(t *testing.T) {
	...
	// Test prefix removal
	filename := "thisuffixElio (2025)-1080p.mp4"
	cmd.prefix = "thisuffix"
...
func TestRenameCommand_RenameFile_MultipleOperations(t *testing.T) {
	...
	// thisuffixtest_file_backup.txt
	// 1. Remove pattern "_file_" -> "thisuffixtest_backup.txt"
	// 2. Remove prefix "thisuffix" -> "test_backup.txt"
	// 3. Remove suffix "_backup.txt" -> "test"
	// Based on test results, actual output may differ
	filename := "thisuffixtest_file_backup.txt"
	cmd.prefix = "thisuffix"
	cmd.suffix = "_backup.txt"
	cmd.pattern = "_file_"
...
func TestRenameCommand_ProcessDirectory_Prefix(t *testing.T) {
	...
	// Create test files
	testFiles := []string{
		"thisuffixElio (2025)-1080p.mp4",
		"thisuffixMovie2 (2024)-720p.mkv",
		"normal_file.txt",
